...
parser.add_argument('--wt_load_freq1', default=2, type=int, help='weight load frequency in first half')
parser.add_argument('--wt_load_freq2', default=2, type=int, help='weight load frequency in second half')
...
def main():
    ...
    if args.model == 'resnet18':
        ...
        if args.use_pretrained:
            pretrained_model_path = "./new_models/imagenet_resnet18_lsq_act_learnable_quantized_lambda_schedule_" + str(args.num_bits) + "bits.ckpt"
            RS_matrix_path = "./new_models/imagenet_resnet18_lsq_act_learnable_quantized_lambda_schedule_" + str(args.num_bits) + "bits_RS_mats.npz"

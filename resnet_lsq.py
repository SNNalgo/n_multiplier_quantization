...
class ResNet(nn.Module):
    def __init__(
        ...
        self.layer1 = self._make_layer(block, num_out_filters, layers[0], nbits_a=nbits_a)
        num_out_filters *= 2
    ...
    def _make_layer(
        self, block, planes, blocks, stride=1, dilate=False, last_activation="relu", nbits_a=4
    ):

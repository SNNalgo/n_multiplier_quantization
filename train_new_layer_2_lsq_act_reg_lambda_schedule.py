...
def main():
    ...
    if args.model == 'resnet18':
        ...
        if args.use_pretrained:
            pretrained_model_path = "./saved_models/imagenet_resnet18_lsq_act_non_quantized_for_4bits.ckpt"
            #pretrained_model_path = "./saved_models/imagenet_resnet18_lsq_act_non_quantized_for_" + str(args.num_bits) + "bits.ckpt"
            #pretrained_model_path = "./saved_models/imagenet_resnet18_90_epochs_lsq_act_non_quantized_for_" + str(args.num_bits) + "bits.ckpt"
    ...
    if args.model == 'resnet50':
        ...
        if args.use_pretrained:
            ...
            pretrained_model_path = "./saved_models/imagenet_resnet50_lsq_act_non_quantized_for_4bits.ckpt"
